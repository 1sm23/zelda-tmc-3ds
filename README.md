...
1. Install `tmc-3ds-v0.8.cia` with FBI, or copy the 3DSX build to the
   Homebrew Launcher.
...
```text
build-3ds/game/tmc-3ds-v0.8.cia
build-3ds/game/tmc-3ds-v0.8.3dsx
```
